...
('20000000-0000-0000-0000-000000000001', 'Python for Software Engineers', 'MIT OpenCourseWare', 'Rigorous foundation in computer science and programming using Python, focusing on algorithms, object-oriented design, and algorithmic complexity.', 'beginner', 35, 4.85, 'https://ocw.mit.edu/search/?q=python%20programming', 0.00),
('20000000-0000-0000-0000-000000000002', 'Modern Python Deep Dive & Metaprogramming', 'DeepLearning.AI', 'Advanced Python language features including decorators, descriptors, generators, async iterators, and memory management under the GIL.', 'advanced', 25, 4.90, 'https://www.coursera.org/search?query=advanced%20python', 49.00),
('20000000-0000-0000-0000-000000000003', 'Mastering Modern TypeScript', 'Frontend Masters', 'Comprehensive TypeScript covering generic constraints, mapped types, conditional types, template literal types, and AST transformations.', 'intermediate', 20, 4.88, 'https://www.typescriptlang.org/docs/', 39.00),
('20000000-0000-0000-0000-000000000004', 'Go: Building High-Performance Concurrent Systems', 'Go Academy', 'Learn idiomatic Go, memory layouts, CSP concurrency with channels and select loops, and high-throughput networking services.', 'intermediate', 30, 4.78, 'https://go.dev/learn/', 59.00),
('20000000-0000-0000-0000-000000000005', 'Rust for Systems Programmers', 'Stanford Online', 'Comprehensive systems development in Rust covering ownership, borrowing, lifetimes, fearless concurrency, and unsafe Rust boundaries.', 'advanced', 40, 4.92, 'https://www.google.com/search?q=site:online.stanford.edu+rust+systems+programming', 79.00),
('20000000-0000-0000-0000-000000000006', 'Data Structures and Algorithms in Modern Python', 'Coursera', 'Essential data structures (trees, graphs, heaps, hash tables) and dynamic programming algorithms analyzed using Python 3.', 'intermediate', 30, 4.80, 'https://www.coursera.org/search?query=data%20structures%20algorithms%20python', 0.00),
...
('20000000-0000-0000-0000-000000000008', 'Enterprise Node.js & TypeScript Backend Architecture', 'Udemy', 'Clean architecture, domain-driven design, dependency injection, and scalable Express/Node microservices with TypeScript.', 'intermediate', 28, 4.75, 'https://www.coursera.org/search?query=node.js%20typescript%20backend', 29.99),
('20000000-0000-0000-0000-000000000009', 'Event-Driven Microservices with Go and gRPC', 'O Reilly Media', 'Designing low-latency event-driven microservices using protocol buffers, gRPC streaming, and distributed tracing.', 'advanced', 24, 4.82, 'https://grpc.io/docs/languages/go/quickstart/', 89.00),
('20000000-0000-0000-0000-000000000010', 'High-Throughput WebSocket and Streaming Servers', 'Pluralsight', 'Building real-time full-duplex communication backends with WebSockets, SSE, and ASGI async server patterns in Python and Node.', 'intermediate', 16, 4.68, 'https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API', 35.00),
('20000000-0000-0000-0000-000000000011', 'Authentication and Authorization Security (OAuth2 & JWT)', 'Security Innovation', 'Deep dive into stateless JWT validation, refresh token rotation, OAuth2 authorization code flows, RBAC, and OWASP API security.', 'intermediate', 15, 4.86, 'https://oauth.net/2/', 49.00),
('20000000-0000-0000-0000-000000000012', 'GraphQL API Design and Federation', 'Apollo GraphQL', 'Schema-first GraphQL API design, DataLoader N+1 query solving, Apollo Federation subgraphs, and query complexity mitigation.', 'intermediate', 20, 4.77, 'https://www.apollographql.com/tutorials/', 0.00),
('20000000-0000-0000-0000-000000000013', 'API Gateway Patterns & Rate Limiting', 'Educative', 'Designing API gateway layers, token bucket rate limiters, request routing, reverse proxies, and TLS termination.', 'advanced', 14, 4.73, 'https://www.coursera.org/search?query=api%20gateway%20rate%20limiting', 39.00),
('20000000-0000-0000-0000-000000000014', 'Asynchronous Job Queues and Background Workers', 'Coursera', 'Scaling asynchronous task execution using Celery, BullMQ, Redis queues, retry strategies, and dead-letter queues.', 'intermediate', 18, 4.79, 'https://www.coursera.org/search?query=celery%20redis%20background%20jobs', 29.00),
('20000000-0000-0000-0000-000000000015', 'Resilient Microservices with Circuit Breakers & Retries', 'Packt Publishing', 'Fault tolerance patterns in distributed systems including circuit breakers, exponential backoff, jitter, and bulkhead isolation.', 'advanced', 16, 4.71, 'https://www.coursera.org/search?query=microservices%20resilience%20circuit%20breaker', 45.00),

-- Databases & Caching (16-24)
('20000000-0000-0000-0000-000000000016', 'PostgreSQL Query Optimization and Internals', 'Postgres Weekly', 'Understanding PostgreSQL query plans (EXPLAIN ANALYZE), index types (B-Tree, GIN, GiST), connection pooling with PgBouncer, and MVCC internals.', 'advanced', 26, 4.93, 'https://www.postgresql.org/docs/current/performance-tips.html', 65.00),
...
('20000000-0000-0000-0000-000000000018', 'Redis for High-Performance Caching and State Management', 'Redis University', 'Redis caching strategies (Cache-Aside, Write-Through), eviction policies, HyperLogLog, Sorted Sets for leaderboards, and Redis Streams.', 'intermediate', 16, 4.84, 'https://redis.io/learn/', 0.00),
('20000000-0000-0000-0000-000000000019', 'Vector Databases & pgvector in Practice', 'Pinecone Academy', 'Storing and querying high-dimensional dense embeddings using pgvector, HNSW indexing, IVFFlat, cosine similarity, and L2 distance metrics.', 'intermediate', 14, 4.92, 'https://www.pinecone.io/learn/vector-database/', 0.00),
('20000000-0000-0000-0000-000000000020', 'Database Sharding, Replication, and High Availability', 'DataCamp', 'Multi-region active-passive replication, read replicas, horizontal table sharding, and consensus algorithms for zero-downtime databases.', 'expert', 22, 4.81, 'https://www.coursera.org/search?query=database%20sharding%20replication', 79.00),
('20000000-0000-0000-0000-000000000021', 'Time-Series and Analytical Data Pipelines', 'ClickHouse Official', 'Designing high-volume append-only time-series databases, column-oriented storage, ClickHouse ingestion, and analytical aggregations.', 'advanced', 20, 4.76, 'https://clickhouse.com/learn', 0.00),
('20000000-0000-0000-0000-000000000022', 'Database Migrations and Schema Evolution in CI/CD', 'Prisma Academy', 'Zero-downtime database migrations, blue-green schema evolution, backward compatibility, and automated schema validation.', 'intermediate', 12, 4.74, 'https://www.prisma.io/dataguide', 0.00),
('20000000-0000-0000-0000-000000000023', 'ACID Transactions, Locking, and Isolation Levels', 'Harvard Online', 'Deep investigation into dirty reads, non-repeatable reads, phantom reads, 2-phase locking, and distributed 2PC transactions.', 'advanced', 18, 4.90, 'https://www.google.com/search?q=site:pll.harvard.edu+database+transactions+isolation', 99.00),
('20000000-0000-0000-0000-000000000024', 'Search Engines: Full-Text Search with Postgres & Elasticsearch', 'Elastic Training', 'Inverted indexes, tokenization, BM25 ranking, fuzzy matching, and combining full-text search with vector embeddings.', 'intermediate', 20, 4.79, 'https://www.elastic.co/guide/index.html', 49.00),
...
('20000000-0000-0000-0000-000000000026', 'Deep Learning Specialization with PyTorch', 'DeepLearning.AI', 'Neural network architectures, convolution networks (CNNs), sequence models (RNNs/LSTMs), batch normalization, and PyTorch autograd.', 'intermediate', 50, 4.93, 'https://course.fast.ai/', 49.00),
...
('20000000-0000-0000-0000-000000000028', 'Generative AI with Large Language Models', 'DeepLearning.AI & AWS', 'LLM lifecycle, prompt engineering, instruction fine-tuning, LoRA/QLoRA parameter-efficient tuning, and RLHF reinforcement learning.', 'intermediate', 30, 4.88, 'https://www.coursera.org/learn/generative-ai-with-llms', 49.00),
('20000000-0000-0000-0000-000000000029', 'Building Production RAG Systems from Scratch', 'LlamaIndex Academy', 'Production-grade Retrieval-Augmented Generation: semantic chunking, multi-modal ingestion, hybrid search, Cohere rerankers, and RAG evaluation (Ragas).', 'intermediate', 22, 4.95, 'https://docs.llamaindex.ai/en/stable/', 0.00),
('20000000-0000-0000-0000-000000000030', 'Autonomous AI Agents and Tool Orchestration', 'DeepLearning.AI', 'Building autonomous agents with LangGraph, AutoGen, and CrewAI featuring tool calling, hierarchical teams, memory persistence, and human-in-the-loop.', 'advanced', 24, 4.92, 'https://www.deeplearning.ai/short-courses/', 39.00),
('20000000-0000-0000-0000-000000000031', 'Fine-Tuning Open Source LLMs (Llama 3, Mistral, Gemma)', 'Weights & Biases', 'Quantization (GGUF, AWQ), dataset synthesis, Unsloth fine-tuning, flash attention, and evaluating hallucination rates with W&B.', 'advanced', 26, 4.87, 'https://huggingface.co/learn', 0.00),
...
('20000000-0000-0000-0000-000000000033', 'Sentence Transformers and Semantic Text Embeddings', 'UKPLab / Hugging Face', 'Bi-encoders, cross-encoders, contrastive loss, training custom domain embeddings with sentence-transformers, and MTEB benchmarks.', 'intermediate', 18, 4.89, 'https://huggingface.co/tasks', 0.00),
('20000000-0000-0000-0000-000000000034', 'LLMOps: Deploying and Monitoring AI in Production', 'Full Stack Deep Learning', 'Model serving with vLLM, TensorRT-LLM, token-level streaming, latency benchmarks, cost optimization, and observability with OpenInference.', 'advanced', 32, 4.86, 'https://fullstackdeeplearning.com/course/', 0.00),
('20000000-0000-0000-0000-000000000035', 'AI Safety, Guardrails, and Red Teaming', 'NVIDIA DLI', 'Guardrails AI, NeMo Guardrails, jailbreak prevention, PII masking, toxic content classification, and automated red teaming.', 'intermediate', 16, 4.79, 'https://www.nvidia.com/en-us/training/', 90.00),
('20000000-0000-0000-0000-000000000036', 'Multimodal AI: Vision, Audio, and Reasoning Models', 'Stanford Online', 'CLIP embeddings, Gemini Pro Vision, Whisper speech recognition, diffusion models, and multimodal agentic reasoning.', 'advanced', 25, 4.88, 'https://online.stanford.edu/courses', 120.00),
...
('20000000-0000-0000-0000-000000000038', 'AI Code Generation and Developer Productivity Tooling', 'GitHub Universe', 'Tree-sitter AST parsing, language server protocol (LSP), automated unit test synthesis, and building Copilot extensions.', 'intermediate', 15, 4.75, 'https://github.com/features/copilot', 0.00),

-- Frontend & Full-Stack (39-45)
('20000000-0000-0000-0000-000000000039', 'Modern React 18/19 & Component Architecture', 'Frontend Masters', 'React hooks (useActionState, useOptimistic), concurrency, server components, Suspense boundaries, and performance profiling.', 'beginner', 24, 4.87, 'https://react.dev/learn', 39.00),
('20000000-0000-0000-0000-000000000040', 'Tailwind CSS Mastery & Custom UI Systems', 'Tailwind Labs', 'Building accessible component libraries, arbitrary variants, fluid typography, dark mode theming, and Framer Motion micro-animations.', 'beginner', 14, 4.92, 'https://tailwindcss.com/docs/installation', 0.00),
...
('20000000-0000-0000-0000-000000000042', 'Interactive Data Visualizations with Recharts and D3', 'Observable HQ', 'SVG geometry, interactive time-series charts, skill radar graphs, network hierarchy graphs, and responsive dashboards.', 'intermediate', 18, 4.80, 'https://observablehq.com/learn', 35.00),
...
('20000000-0000-0000-0000-000000000044', 'Building AI Chat UIs with Streaming and Markdown', 'Vercel AI SDK', 'Vercel AI SDK, token streaming responses, LaTeX math rendering, code snippet copy blocks, and generative UI widgets.', 'intermediate', 16, 4.93, 'https://ai-sdk.dev/docs', 0.00),
('20000000-0000-0000-0000-000000000045', 'Full-Stack Monorepo Architecture with Turborepo', 'Vercel Academy', 'Managing multi-package TypeScript workspaces, shared UI components, shared ESLint/tsconfig, and incremental remote caching.', 'advanced', 18, 4.78, 'https://turborepo.com/docs', 0.00),

-- DevOps, Cloud, CI/CD, and Containers (46-54)
('20000000-0000-0000-0000-000000000046', 'Docker & Containerization for Developers', 'Docker Official', 'Building lean multi-stage Dockerfiles, non-root security principles, volume management, and container networking.', 'beginner', 15, 4.88, 'https://docs.docker.com/get-started/', 0.00),
('20000000-0000-0000-0000-000000000047', 'Kubernetes from Basics to Production Clusters', 'Linux Foundation', 'CKA syllabus: Pod lifecycle, ReplicaSets, StatefulSets, Ingress controllers, Persistent Volumes, and cluster debugging.', 'intermediate', 38, 4.89, 'https://kubernetes.io/docs/tutorials/kubernetes-basics/', 150.00),
...
('20000000-0000-0000-0000-000000000049', 'Automated CI/CD with GitHub Actions', 'GitHub Learning Lab', 'Custom composite actions, workflow matrix builds, secret scanning, caching dependencies, and automatic container deployments.', 'beginner', 14, 4.86, 'https://docs.github.com/en/actions', 0.00),
...
('20000000-0000-0000-0000-000000000051', 'Cloud-Native Observability: Prometheus, Grafana, OpenTelemetry', 'CNCF', 'Distributed tracing, structured JSON logs, RED metrics (Rate, Errors, Duration), Grafana alert manager, and OTEL collectors.', 'advanced', 22, 4.81, 'https://opentelemetry.io/docs/', 0.00),
('20000000-0000-0000-0000-000000000052', 'Zero-Trust Cloud Security and IAM Hardening', 'SANS Institute', 'Least-privilege IAM policies, AWS KMS envelope encryption, mutual TLS (mTLS), and runtime security with Falco.', 'advanced', 20, 4.90, 'https://www.coursera.org/search?query=cloud%20security%20iam', 190.00),
('20000000-0000-0000-0000-000000000053', 'Serverless Architecture with AWS Lambda and DynamoDB', 'Serverless Guru', 'Single-table DynamoDB design, event-driven Lambda triggers, API Gateway HTTP APIs, and cold-start mitigations.', 'intermediate', 18, 4.79, 'https://aws.amazon.com/training/learn-about/serverless/', 45.00),
('20000000-0000-0000-0000-000000000054', 'GitOps and Progressive Delivery with ArgoCD and Flagger', 'Codefresh', 'Git as single source of truth, declarative sync with ArgoCD, canary deployments, and automated rollback upon SLO degradation.', 'advanced', 18, 4.83, 'https://argo-cd.readthedocs.io/en/stable/getting_started/', 0.00),
...
('20000000-0000-0000-0000-000000000056', 'Distributed Event Streaming with Apache Kafka', 'Confluent Developer', 'Kafka brokers, topics, partitions, consumer groups, exactly-once semantics (EOS), schema registry, and Kafka Connect.', 'intermediate', 30, 4.89, 'https://developer.confluent.io/courses/apache-kafka/events/', 0.00),
...
('20000000-0000-0000-0000-000000000058', 'High-Scale Caching, Sharding, and Replication Patterns', 'O Reilly Media', 'Cache stampede prevention, consistent hashing algorithms, bloom filters, and distributed write-ahead logs.', 'advanced', 24, 4.84, 'https://www.coursera.org/search?query=distributed%20systems%20caching%20sharding', 69.00),
